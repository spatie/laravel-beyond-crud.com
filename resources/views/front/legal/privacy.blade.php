...
@section('description', 'Privacy & cookie policy for Laravel Beyond CRUD — Building larger-than-average web applications')
...
Spatie may use your email address to send marketing as well as other news relating to Laravel Beyond CRUD or some of the other Spatie products if you subscribed the direct mailing list with consent. You can withdraw your consent at any time, without any reasoning and free of charge by, for example, clicking on the unsubscribe button provided at the bottom of each promotional email message.
...
- Essential website cookies: these cookies are necessary to give you as a visitor an optimal experience on our website. Spatie needs these cookies for some critical features like the payment of the Laravel Beyond CRUD Course.
...
- Paddle_js cookies: cookies that are necessary for our payment integration with Paddle. These cookies are used during the checkout process when you buy the Laravel Beyond Crud Course. More information on Paddle can be found on their website: [paddle.com](http://paddle.com/).
