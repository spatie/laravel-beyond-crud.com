            ...
            <div class="border-l border-r border-b border-gray-200 bg-white">
                ...
                <div class="flex-grow pt-12 pb-6 px-12  justify-center bg-gray-100">
                    ...
                    <ul class="pb-4 leading-relaxed">
                            ...
                            <span class="ml-2">Get Laravel Beyond CRUD &amp; <a class="markup-link" href="https://testing-laravel.com">Testing Laravel</a> with a <strong class="font-semibold">30% discount</strong>!</span>
                            </li>
                    </ul>
